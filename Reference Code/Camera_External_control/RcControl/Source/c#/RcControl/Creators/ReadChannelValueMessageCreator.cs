...
{
    public class ReadChannelValueMessageCreator : BaseMessageCreator<ReadChannelValueMessage>
    {
        public override byte[] CreateMessage(ReadChannelValueMessage message)
        {
            if (message == null)
