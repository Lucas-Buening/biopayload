...
{
    public class SetChannelValueMessageResponseHandler : SysexMessageHandler<SetChannelValueMessageResponse>
    {
        #region Variables
        private const byte CommandByte = RcCommands.SET_CHANNEL_VALUE;

        protected new const string BaseExceptionMessage =
            "Error with the incoming byte. This is not a valid SetChannelValueResponseMessage. ";
        ...
        #region Ctor / Dtor
        public SetChannelValueMessageResponseHandler(IMessageBroker messageBroker)
            : base(messageBroker)
        { }
        #endregion
