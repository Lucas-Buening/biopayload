...
{
    public class ReadConfigurationMessageCreator : BaseMessageCreator<ReadConfigurationMessage>
    {
        public override byte[] CreateMessage(ReadConfigurationMessage message)
        {
            if (message == null)
